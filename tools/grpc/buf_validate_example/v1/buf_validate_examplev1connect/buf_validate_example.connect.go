...
package buf_validate_examplev1connect

import (
	v1 "buf-validate-example/tools/grpc/buf_validate_example/v1"
	context "context"
	errors "errors"
...
const (
	...
	TaskServiceName = "buf_validate_example.v1.TaskService"
	// UserServiceName is the fully-qualified name of the UserService service.
	UserServiceName = "buf_validate_example.v1.UserService"
)
...
const (
	...
	TaskServiceCreateTaskProcedure = "/buf_validate_example.v1.TaskService/CreateTask"
	// TaskServiceGetTaskByUserProcedure is the fully-qualified name of the TaskService's GetTaskByUser
	// RPC.
	TaskServiceGetTaskByUserProcedure = "/buf_validate_example.v1.TaskService/GetTaskByUser"
	// UserServiceGetUserProcedure is the fully-qualified name of the UserService's GetUser RPC.
	UserServiceGetUserProcedure = "/buf_validate_example.v1.UserService/GetUser"
)

// TaskServiceClient is a client for the buf_validate_example.v1.TaskService service.
...
// NewTaskServiceClient constructs a client for the buf_validate_example.v1.TaskService service. By
...
// CreateTask calls buf_validate_example.v1.TaskService.CreateTask.
...
// GetTaskByUser calls buf_validate_example.v1.TaskService.GetTaskByUser.
...
// TaskServiceHandler is an implementation of the buf_validate_example.v1.TaskService service.
...
func NewTaskServiceHandler(svc TaskServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	return "/buf_validate_example.v1.TaskService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedTaskServiceHandler) CreateTask(context.Context, *connect_go.Request[v1.CreateTaskRequest]) (*connect_go.Response[v1.CreateTaskResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("buf_validate_example.v1.TaskService.CreateTask is not implemented"))
}
...
func (UnimplementedTaskServiceHandler) GetTaskByUser(context.Context, *connect_go.Request[v1.GetTaskByUserRequest]) (*connect_go.Response[v1.GetTaskByUserResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("buf_validate_example.v1.TaskService.GetTaskByUser is not implemented"))
}

// UserServiceClient is a client for the buf_validate_example.v1.UserService service.
type UserServiceClient interface {
	GetUser(context.Context, *connect_go.Request[v1.GetUserRequest]) (*connect_go.Response[v1.GetUserResponse], error)
}

// NewUserServiceClient constructs a client for the buf_validate_example.v1.UserService service. By
// default, it uses the Connect protocol with the binary Protobuf Codec, asks for gzipped responses,
// and sends uncompressed requests. To use the gRPC or gRPC-Web protocols, supply the
// connect.WithGRPC() or connect.WithGRPCWeb() options.
//
...
// GetUser calls buf_validate_example.v1.UserService.GetUser.
...
// UserServiceHandler is an implementation of the buf_validate_example.v1.UserService service.
...
func NewUserServiceHandler(svc UserServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	return "/buf_validate_example.v1.UserService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedUserServiceHandler) GetUser(context.Context, *connect_go.Request[v1.GetUserRequest]) (*connect_go.Response[v1.GetUserResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("buf_validate_example.v1.UserService.GetUser is not implemented"))
}
