...
func (x *GetUserRequest) GetUpdatedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.UpdatedAt
	}
	return nil
...
var file_v1_user_proto_rawDesc = []byte{
	...
	0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xf8, 0x01, 0x0a, 0x0e, 0x47, 0x65,
	...
	0x65, 0x64, 0x41, 0x74, 0x22, 0xf9, 0x01, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72,
	...
	0x74, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x09, 0x5a,
...
var file_v1_user_proto_depIdxs = []int32{
	2, // 0: user.v1.GetUserRequest.created_at:type_name -> google.protobuf.Timestamp
	2, // 1: user.v1.GetUserRequest.updated_at:type_name -> google.protobuf.Timestamp
	2, // 2: user.v1.GetUserResponse.created_at:type_name -> google.protobuf.Timestamp
	2, // 3: user.v1.GetUserResponse.updated_at:type_name -> google.protobuf.Timestamp
